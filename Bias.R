...
data_gen <- function(t_values,simulation_values) {
  ...
  colnames(table_of_values) <- c("t_value","no_of_simulations","replication_no","Bias")
...
boxplot( Bias~t_value*no_of_simulations,data= table, ylab='Bias', xlab='t values & No of Simulations', main = 'Bias Plot' )
